...
b1dmjcavf6faqv0glrdjbr7ma6      	1599889921	\\x
j07adq6onju6tegdqu3ju1a790      	1599889922	\\x
\.
...
93	JL.GEREJA NO 27 RT 02 /RW 01 ( CABANG )	ADIPALA	3301150	3301	33	INDONESIA
...
COPY public.item (id, code, name, stock, acq_price, price, created_by, created_at, updated_by, updated_at) FROM stdin;
\.
...
COPY public.news (id, cat_id, title, permalink, summary, content, banner, flag_published, created_at, created_by, updated_at, updated_by) FROM stdin;
\.
...
COPY public.orders (id, order_number, unit_id, status, delivery_date, delivery_provider, delivery_receipt_no, created_at, created_by, updated_at, updated_by) FROM stdin;
\.
...
74	163	YULIA SURYANTI	76	0812223338205			1	2019-12-29 00:00:00	2024-12-29 00:00:00	admin	2020-09-10 01:55:22.875541	\N	\N
...
91	180	NELLY ANDRIANY	93	08999921157			1	2020-02-25 00:00:00	2025-02-25 00:00:00	admin	2020-09-10 16:04:14.056134	\N	\N
...
SELECT pg_catalog.setval('public.address_id_seq', 144, true);
...
SELECT pg_catalog.setval('public.meta_tag_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.teacher_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.unit_id_seq', 142, true);
