...
CREATE TABLE "public"."YiiSession" (
    ...
    "expire" integer,
    "data" bytea,
    CONSTRAINT "YiiSession_pkey" PRIMARY KEY ("id")
) WITH (oids = false);
...
CREATE SEQUENCE address_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO "address" ("id", "address_1", "address_2", "district", "city", "state", "country") VALUES
...
CREATE TABLE "public"."authassignment" (
    ...
    "bizrule" text,
    "data" text,
    CONSTRAINT "authassignment_itemname_fkey" FOREIGN KEY (itemname) REFERENCES authitem(name) NOT DEFERRABLE,
    CONSTRAINT "authassignment_userid_fkey" FOREIGN KEY (userid) REFERENCES users(id) NOT DEFERRABLE
) WITH (oids = false);
...
DROP SEQUENCE IF EXISTS authitem_id_seq;
CREATE SEQUENCE authitem_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE "public"."authitem" (
    "id" bigint DEFAULT nextval('authitem_id_seq') NOT NULL,
    "type" integer NOT NULL,
    "name" character varying(256) NOT NULL,
    "description" text,
    "bizrule" text,
    "data" text,
    CONSTRAINT "authitem_name_key" UNIQUE ("name"),
    CONSTRAINT "authitem_pkey" PRIMARY KEY ("id")
) WITH (oids = false);

INSERT INTO "authitem" ("id", "type", "name", "description", "bizrule", "data") VALUES
(1,    2,    'admin',    'Role Admin',    NULL,    NULL),
(2,    2,    'management',    'Role Management',    NULL,    NULL),
(3,    2,    'unit',    'Role Unit',    NULL,    NULL);
...
(1,    'Berita',    'Berita & Artikel terkait prisma kalkulator tangan',    'admin',    '2019-11-23 05:54:26.841807',    NULL,    NULL);

DROP TABLE IF EXISTS "item";
DROP SEQUENCE IF EXISTS item_id_seq;
CREATE SEQUENCE item_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
DROP SEQUENCE IF EXISTS meta_tag_id_seq;
CREATE SEQUENCE meta_tag_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE "public"."meta_tag" (
    "id" bigint DEFAULT nextval('meta_tag_id_seq') NOT NULL,
    "name" character varying(256) NOT NULL,
    "timestamp_created" timestamp,
    "user_create" character varying(32),
    CONSTRAINT "meta_tag_name_key" UNIQUE ("name"),
...
CREATE SEQUENCE news_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
CREATE TABLE "public"."news" (
    ...
    "updated_at" timestamp,
    "updated_by" character varying(32),
    CONSTRAINT "news_permalink_key" UNIQUE ("permalink"),
...
CREATE SEQUENCE order_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
CREATE TABLE "public"."order_detail" (
    "id" bigint DEFAULT nextval('order_detail_id_seq') NOT NULL,
...
DROP SEQUENCE IF EXISTS ref_cities_id_seq;
CREATE SEQUENCE ref_cities_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE "public"."ref_cities" (
    "id" bigint DEFAULT nextval('ref_cities_id_seq') NOT NULL,
    "state_id" bigint NOT NULL,
    "name" character varying(128) NOT NULL,
    "unit_code" character varying(8),
    CONSTRAINT "ref_cities_pkey" PRIMARY KEY ("id"),
    CONSTRAINT "ref_cities_state_id_fkey" FOREIGN KEY (state_id) REFERENCES ref_states(id) NOT DEFERRABLE
) WITH (oids = false);

INSERT INTO "ref_cities" ("id", "state_id", "name", "unit_code") VALUES
...
DROP SEQUENCE IF EXISTS ref_districts_id_seq;
CREATE SEQUENCE ref_districts_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE "public"."ref_districts" (
    "id" bigint DEFAULT nextval('ref_districts_id_seq') NOT NULL,
    "city_id" bigint NOT NULL,
    "name" character varying(128) NOT NULL,
    CONSTRAINT "ref_districts_pkey" PRIMARY KEY ("id"),
    CONSTRAINT "ref_districts_city_id_fkey" FOREIGN KEY (city_id) REFERENCES ref_cities(id) NOT DEFERRABLE
) WITH (oids = false);

INSERT INTO "ref_districts" ("id", "city_id", "name") VALUES
...
DROP SEQUENCE IF EXISTS ref_states_id_seq;
CREATE SEQUENCE ref_states_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE "public"."ref_states" (
    "id" bigint DEFAULT nextval('ref_states_id_seq') NOT NULL,
    "name" character varying(128) NOT NULL,
    CONSTRAINT "ref_states_pkey" PRIMARY KEY ("id")
) WITH (oids = false);

INSERT INTO "ref_states" ("id", "name") VALUES
(11,    'ACEH'),
(12,    'SUMATERA UTARA'),
(13,    'SUMATERA BARAT'),
(14,    'RIAU'),
...
DROP SEQUENCE IF EXISTS ref_villages_id_seq;
CREATE SEQUENCE ref_villages_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE "public"."ref_villages" (
    "id" bigint DEFAULT nextval('ref_villages_id_seq') NOT NULL,
    "district_id" bigint NOT NULL,
    "name" character varying(128) NOT NULL,
    CONSTRAINT "ref_villages_pkey" PRIMARY KEY ("id")
) WITH (oids = false);


DROP TABLE IF EXISTS "student";
DROP SEQUENCE IF EXISTS student_id_seq;
CREATE SEQUENCE student_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
CREATE TABLE "public"."unit" (
    "id" bigint DEFAULT nextval('unit_id_seq') NOT NULL,
    ...
    CONSTRAINT "unit_unit_no_key" UNIQUE ("unit_no")
) WITH (oids = false);

INSERT INTO "unit" ("id", "unit_no", "owner", "address_id", "wa_number", "trainer", "consultant", "status", "start_date", "expired_at", "created_by", "created_at", "updated_by", "updated_at") VALUES
(2,    1,    'Liani Mesisotya Murti, S.Pd.',    3,    '08986650415',    'Zaenal Ahmad, S.Ag.',    'Zaenal Ahmad, S.Ag.',    1,    '2019-09-01 00:00:00',    '2024-08-31 00:00:00',    'admin',    '2019-12-01 05:54:37.849988',    NULL,    NULL),
...
(3,    100,    'i gusti astuti, se akt',    5,    '081353020160',    'zaenal ahmad',    '',    1,    '2019-10-04 00:00:00',    '2024-10-04 00:00:00',    'admin',    '2019-12-26 17:29:22.484547',    NULL,    NULL);
...
INSERT INTO "users" ("id", "name", "username", "email", "password", "salt", "status", "flag_delete", "login_atemp", "last_login_attempt", "last_login_time", "timestamp_created", "user_create", "timestamp_updated", "user_update") VALUES
(2,    'Purwanto',    'purwa',    'purwanto@modefashiongroup.com',    '$2y$13$E/8Q2W27QpEiEGBpZPW5HuoohCvsrKq.p.NtU8Pdr64RzyHDPM7/C',    '$2y$13$rwqp1gCirA8u6cHtW/GlhT',    1,    0,    0,    NULL,    NULL,    '2016-03-17 13:36:49',    'admin',    NULL,    NULL),
(1,    'Administrator',    'admin',    'and.thau@gmail.com',    '$2y$13$YE01ZCajBeIEjyPccRRlteXL50RfykmRMytx6vBgHjBDs5vni/Oyi',    '$2y$13$jv/n.WhUXe0OdfVlkIGnc2',    1,    0,    0,    NULL,    NULL,    '2016-03-17 13:28:17',    'admin',    NULL,    NULL);

-- 2020-03-22 07:00:06.932456+00
