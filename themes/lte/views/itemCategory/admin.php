...
$this->pageTitle = 'Kategori Barang';
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">
                <small>Kategori Barang yang ada di dalam sistem</small>
            </h3>
        </div>
        ...
        <div class="box-footer">
            <?php echo CHtml::link('Tambah Kategori', array('itemCategory/create'), array('class' => 'btn btn-primary')) ?>
        </div>
