...
<div class="box-body" id="search">
	<div class="form-group">
		<?php echo $form->textField($model,'unit_no',array('class'=>'form-control','placeholder'=>'Nomor Unit')); ?>
	</div>
    <div class="form-group">
        <?php echo $form->textField($model,'owner',array('class'=>'form-control','placeholder'=>'Pemilik')); ?>
    </div>
    <div class="form-group">
