    ...
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo CHtml::encode($model->title); ?>
                <small class="hidden-xs"> ditulis oleh <strong><?php echo $model->user_create; ?></strong></small>
            </h3>
            ...
            <div class="hidden-sm hidden-md hidden-lg">
                <small>Ditulis oleh <strong><?php echo $model->user_create; ?></strong>
                    |  <?php echo $model->timestamp_created; ?></span></small>
            </div>
        </div>
        <div class="box-body">
