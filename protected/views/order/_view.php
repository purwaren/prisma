...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('delivery_provider')); ?>:</b>
	<?php echo CHtml::encode($data->delivery_provider); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('delivery_receipt_no')); ?>:</b>
	<?php echo CHtml::encode($data->delivery_receipt_no); ?>
	<br />
