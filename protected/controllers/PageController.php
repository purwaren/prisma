...
class PageController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('index','view','create','update','upload','admin','delete'),
				'users'=>array('@'),
				'roles'=>array('admin','management')
			),
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('index','view','create','update','upload','admin'),
				'users'=>array('@'),
				'roles'=>array('unit')
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['PageForm']))
		{
			...
			if(!Yii::app()->user->checkAccess('admin'))
				$model->flag_published = Page::FLAG_PUBLISHED_INACTIVE;
	...
	public function actionAdmin()
	{
		...
		//only allowed to edit their own page, except admin
		if(!Yii::app()->user->checkAccess('admin'))
