...
class AlbumController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','admin','upload','view','delete','deleteContent'),
				'users'=>array('@'),
			),
    ...
    {
        AlbumContent::model()->deleteByPk($id);
	...
	public function actionUpload($id)
	{
        ...
        $model2 = new VideoUploadForm();
		$album = $this->loadModel($id);
		if(Yii::app()->request->isAjaxRequest && Yii::app()->request->isPostRequest)
		{
			$model->file = CUploadedFile::getInstanceByName('files');
			...
			if($model->save())
			{
				...
				'errorkeys'=>array($_POST['file_id'])
			));
			Yii::app()->end();
		}
		if(isset($_POST['VideoUploadForm']))
        {
            $model2->attributes = $_POST['VideoUploadForm'];
            $model2->albumId = $album->id;
            if($model2->save())
            {
